...
public class MarkingReviewStatusProjection {
    ...
    public MarkingReviewStatusProjection(long submissionId, long tutorId, StudentProfile student, int revision, State state, LocalDateTime requestedAt) {
        this.sourceSubmissionId = positive(submissionId, "Submission id"); this.tutorId = positive(tutorId, "Tutor id"); this.studentProfile = required(student, "Student profile"); set(revision, state, requestedAt);
    }
    ...
    public Long getSourceSubmissionId() { return sourceSubmissionId; } public Long getTutorId() { return tutorId; } public StudentProfile getStudentProfile() { return studentProfile; } public int getRevision() { return revision; } public State getState() { return state; } public LocalDateTime getRequestedAt() { return requestedAt; }
}
