...
public class MasteryApprovedResult {
    ...
    public MasteryApprovedResult(long sourceSubmissionId, long tutorId, StudentProfile student, SyllabusTopic topic,
        ...
        replace(approvedMarks, availableMarks, repeatedMistakeCount, revision, active, reviewedAt);
    }
    public boolean replace(BigDecimal marks, BigDecimal total, int repeated, int nextRevision, boolean nextActive, LocalDateTime at) {
    ...
    public Long getId() { return id; } public Long getSourceSubmissionId() { return sourceSubmissionId; } public StudentProfile getStudentProfile() { return studentProfile; }
