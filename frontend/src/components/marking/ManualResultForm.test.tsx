...
const review: MarkingReview = { id: 10, studentId: 2, worksheetId: 3, worksheetQuestionId: 5, questionBankId: 5, extractedAnswer: "Metal conducts heat.", modelAnswer: "Metal conducts heat.", maxMarks: 2, aiSuggestedMarks: null, aiSuggestedOutcome: null, aiErrorCategory: null, missingKeywords: [], aiSuggestedFeedback: null, reviewStatus: "APPROVED", approvedMarks: 1.5, approvedFeedback: "Add heat-transfer detail.", reviewedByUserId: 1, reviewedAt: "2026-08-27T10:00:00", providerResponseValid: null, history: [{ id: 1, action: "APPROVED", reviewerUserId: 1, previousStatus: "PENDING_REVIEW", newStatus: "APPROVED", previousMarks: null, newMarks: 1.5, previousFeedback: null, newFeedback: "Add heat-transfer detail.", createdAt: "2026-08-27T10:00:00" }] };
