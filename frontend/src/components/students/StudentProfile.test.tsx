...
const profile: TutorStudentProfile = {
  ...
  tutorOnly: { activeAlerts: [{ id: 3, type: "MASTERY", severity: "MEDIUM", status: "OPEN", title: "Adaptation needs practice", createdAt: "2026-09-02T10:00:00" }], reports: [{ id: 6, reportCode: "P5-SEP", status: "DRAFT", periodStart: "2026-09-01", periodEnd: "2026-09-30", generatedAt: null, finalizedAt: null }] },
};
...
describe("StudentProfile", () => {
  ...
  it("shows safe partial and new-profile states without fabricated values", async () => {
    render(<StudentProfile studentId={31} loadProfile={async () => ({ ...profile, classes: [], metrics: { averageMastery: null, topicCount: 0, totalAttempts: 0, lastCalculatedAt: null }, mastery: [], learningProfile: { strengths: [], focusAreas: [] }, history: [], worksheets: [], tutorOnly: { activeAlerts: [], reports: [] } })} />);
