import { beforeEach, describe, expect, it, vi } from "vitest"; import { MAX_UPLOAD_BYTES, approveMarkingReview, createManualResult, createManualResults, createMarkingReview, createOcrDocument, fetchManualResults, fetchMarkingReview, fetchStudentMistakes, fetchStudentWorksheetResults, parseMarkingReview, parseStudentMistakeReviews, parseStudentWorksheetResultsResponse, submitOcrForTutorReview, validateUploadFiles } from "./submissions";
...
describe("Student submission document client", () => {
  ...
  it("submits confirmed OCR page mappings to the Student-only review endpoint", async () => {
